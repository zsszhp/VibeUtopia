...
### 多人协作 Git 工作流规范
- Date: 2026-05-15（2026-05-14 初版，2026-05-15 更新）
- Context: 多人开发项目，用户明确强制协作规范
- Instructions:
  ...
  - **工作进度记录**: 已完成的工作进度必须写入 MEMORY.md 文件，避免其他同事重复工作
  - **记忆文件同步**: MEMORY.md 更新后必须提交推送到云端，确保所有同事能参考最新规范
  - 这是强制性工作流，不能跳过任何步骤
